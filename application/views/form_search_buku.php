...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
      <ul class="navbar-nav ml-auto">
        <li class="nav-item">
          <form class="form-inline my-2 my-lg-0 mr-lg-2" action="<?php echo base_url('/welcome/hasil')?>" action="GET">
           <form action="<?php echo base_url('/welcome/hasil')?>" action="GET">
        ...
        <li class="nav-item">
          <a class="nav-link" data-toggle="modal" data-target="#exampleModal">
            <?php echo anchor('welcome/logout/', 'Logout'); ?></a>
        </li>
      </ul>
    </div>
  </nav>
